...
class SingleHeadOriginLayer(nn.Module):
    def __init__(self, net_params):
        super().__init__()
        net_params['depth'] = net_params['L1_depth']
        net_params['dropout'] = net_params['L1_dropout']
        net_params['layers'] = net_params['L1_layers']
...
class SingleHeadFragmentLayer(nn.Module):
    def __init__(self, net_params):
        super().__init__()
        net_params['depth'] = net_params['L2_depth']
        net_params['dropout'] = net_params['L2_dropout']
        net_params['layers'] = net_params['L2_layers']
        self.AtomEmbedding = Atom_AttentiveFP(net_params)
...
class SingleHeadJunctionLayer(nn.Module):
    def __init__(self, net_params):
        ...
        net_params['depth'] = net_params['L3_depth']
        net_params['dropout'] = net_params['L3_dropout']
        net_params['layers'] = net_params['L3_layers']
